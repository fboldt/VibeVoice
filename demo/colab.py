...
def create_demo_interface(demo_instance: VibeVoiceDemo):
    with gr.Blocks(title="VibeVoice AI Podcast Generator") as interface:
        ...
        <div style="text-align: center; margin: 20px auto; max-width: 800px;">
            ...
            <a href="https://github.com/harry2141985/Google-Collab-Notebooks" target="_blank" style="display: inline-block; padding: 10px 20px; background-color: #4285F4; color: white; border-radius: 6px; text-decoration: none; font-size: 1em;">🥳 Run on Google Colab</a>
        </div>
        """)
        with gr.Row():
